            ...
            <div class="max-w-2xl mx-auto space-y-6">
                ...
                <div class="fade-in-up bg-emerald-50 rounded-3xl p-8 border border-emerald-200">
                    ...
                    <div class="mt-6 flex justify-center">
                        <a href="../novosite/assets/pdf/<?php echo htmlspecialchars($resultado['arquivo_pdf']); ?>" download class="inline-flex items-center gap-2 px-6 py-3 bg-primary-600 hover:bg-primary-700 text-white font-medium rounded-lg transition-colors shadow-sm">
